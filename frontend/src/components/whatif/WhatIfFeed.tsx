...
import { IconLoader2, IconMoodEmpty, IconRefresh } from "@tabler/icons-react";
...
export default function WhatIfFeed({ initialScenarios, initialTotal, category, sort }: WhatIfFeedProps) {
